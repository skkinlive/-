...
자작 TRPG를 온라인에서 플레이하기 위한 Foundry VTT 시스템입니다.
...
1. Foundry VTT의 `Data/systems` 폴더에 `custom-trpg` 폴더를 복사합니다.
2. Foundry VTT를 재시작합니다.
3. 월드를 생성할 때 "Custom TRPG System"을 선택합니다.
